...
import { ITaskerLocals, LocalArrays } from "../custom-types";
...
export interface TK {
   ...
   * Colour](https://tasker.joaoapps.com/userguide/en/help/ah_scene_element_background_colour.html).
   ...
   * Position](https://tasker.joaoapps.com/userguide/en/help/ah_scene_element_position.html).
   * @param scene Scene name
   * @param element Element name
   ...
   * Colour](https://tasker.joaoapps.com/userguide/en/help/ah_scene_element_text_colour.html).
   * @param scene Scene name
   * @param element Element name
   ...
   *
   * See also: action [Element
   * Visibility](https://tasker.joaoapps.com/userguide/en/help/ah_scene_element_visibility.html).
   * @param scene Scene name
   * @param element Element name
   ...
   * @param varName
   */
  local(varName: LocalArrays): string;
   ...
   * @param displayAs one of **Overlay**, **OverBlocking**, **OverBlockFullDisplay**, **Dialog**, **DialogBlur**,
   *     **DialogDim**, **ActivityFullWindow**, **ActivityFullDisplay**, **ActivityFullDisplayNoTitle**
   * @param hoffset percentage horizontal offset for the scene -100% to 100% (not relevant for full screen/window
   *     display types)
   * @param voffset percentage vertical offset for the scene -100% to 100% (not relevant for full screen/window
   *     display types)
